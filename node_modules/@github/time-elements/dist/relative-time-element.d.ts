import { Unit } from './duration-format.js';
declare const HTMLElement: {
    new (): HTMLElement;
    prototype: HTMLElement;
};
export declare type Format = 'auto' | 'micro' | 'elapsed' | string;
export declare type Tense = 'auto' | 'past' | 'future';
...
export default class RelativeTimeElement extends HTMLElement implements Intl.DateTimeFormatOptions {
    ...
    getFormattedDate(now?: Date): string | undefined;
